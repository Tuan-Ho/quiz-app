...
continue_btn.onclick = () => {
    ...
    startTimer(countDownTimer); //calling startTimer function
    startTimerLine(0); //calling startTimerLine function
}

let timeValue = countDownTimer;
let que_count = 0;
let que_numb = 1;
let userScore = 0;
let counter;
...
function showQuetions(index) {
    ...
    shuffle(selectedQuestions[index].options);

    //creating a new span and div tag for question and option and passing the value using array index
    let que_tag = '<span>' + selectedQuestions[index].numb + ". " + questions[index].question + '</span>';
    if (selectedQuestions[index].questionImageLink) {
        let queImageContent = '<img src="' + selectedQuestions[index].questionImageLink + '" alt="Question Image"></img>';
        que_image.innerHTML = queImageContent;
    }
    else {
        que_image.innerHTML = '';
    }
